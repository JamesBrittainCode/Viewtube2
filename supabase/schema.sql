...
create index if not exists idx_family_link_codes_code_expires on public.family_link_codes using btree(code, expires_at);
create index if not exists idx_family_links_child_active on public.family_links using btree(child_id, status);
create index if not exists idx_family_links_parent_active on public.family_links using btree(parent_id, status);
create index if not exists idx_family_blocked_child_channel on public.family_blocked_channels using btree(child_id, blocked_channel_id);
